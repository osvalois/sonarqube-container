# Use SonarQube Community Edition - Version 24.12 for compatibility
...
FROM sonarqube:24.12.0-community
...
LABEL org.opencontainers.image.title="SonarQube DevSecOps 24.12"
LABEL org.opencontainers.image.description="SonarQube 24.12 with AI-powered code analysis and advanced security features"
...
RUN { \
        ...
        printf "fi\n"; \
        printf "\n"; \
        printf "echo \"Starting SonarQube 24.12 with: \$SONAR_APP_JAR\"\n"; \
        printf "echo \"Container optimized for 24.12 with Railway support\"\n"; \
